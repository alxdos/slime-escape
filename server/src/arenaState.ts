...
export const PUBLIC_ARENA_WORLD_SIZE_WU = 40;
export const PUBLIC_ARENA_SPAWN_MARGIN_WU = 2;

export const PUBLIC_ARENA_WORLD_BOUNDS: PublicArenaWorldBounds = {
  width: PUBLIC_ARENA_WORLD_SIZE_WU,
  height: PUBLIC_ARENA_WORLD_SIZE_WU,
  minX: -PUBLIC_ARENA_WORLD_SIZE_WU / 2,
  maxX: PUBLIC_ARENA_WORLD_SIZE_WU / 2,
  minY: -PUBLIC_ARENA_WORLD_SIZE_WU / 2,
  maxY: PUBLIC_ARENA_WORLD_SIZE_WU / 2
};
