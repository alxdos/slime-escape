...
| [007-hud-and-menu.md](007-hud-and-menu.md) | [/] | Полноценное меню выбора режима, HUD с HP/таймером/волной, пауза, экран результата | `UiShell` (фазы `menu`/`running`/`paused`/`result`), data-driven меню из `playableModes`, HUD как пассивный потребитель `SnapshotPair`, единый owner pause/resume |
