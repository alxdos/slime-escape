...
| ID | Status | Task | Note |
|----|--------|------|------|
| T1 | [x] | Record the architecture decision for the public online arena runtime and link the story to it. | Added [online-session-hosting.md](../design/online-session-hosting.md). |
