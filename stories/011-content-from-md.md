...
- Status: in-progress
- Created: 2026-04-23
- Updated: 2026-04-23 (T2: seed-литералы enemies вынесены в `src/shared/content/enemies.generated.ts`; `enemies.ts` оставлен владельцем типов, реестра и `validateEnemyRegistry`)
