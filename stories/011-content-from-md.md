...
- Status: in-progress
- Created: 2026-04-23
- Updated: 2026-04-23 (T3: enemy audio seed-маппинг вынесен в `src/main/audio/enemyAudio.generated.ts`; `AudioMappings.ts` оставлен владельцем типов, валидации и остальных маппингов)
