...
- `design/public-multiplayer-arena.md` is removed; `design/online-session-hosting.md` covers the Node host contract; every `design/` file and `stories/` file that referenced the removed decision is updated.
