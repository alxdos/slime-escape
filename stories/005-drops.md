...
- Status: done
- Created: 2026-04-19
- Updated: 2026-04-19 (история закрыта: все Tasks выполнены, контракты соблюдены, тесты — `npm test` 19 файлов / 177 кейсов — зелёные; `Index` в `design/README.md` актуален)
