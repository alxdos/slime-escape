...
| T3 | [x] | Add companion runtime entity support, `CompanionSystem`, inertial movement modes, deterministic threat acquisition, ghost follow, rescue progress, and boop impulse behavior. |
