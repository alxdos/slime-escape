...
- Видит: startup-заставка больше не растягивает реальную загрузку ассетов фейковыми счётчиками. После загрузки ассетов она продолжает короткий игровой ритуал подготовки мира: `Пробуждаем слизь`, `Спавним слаймов`, `Проектируем босса`.
