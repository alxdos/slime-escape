...
| T5 | [x] | Common visual типы и константа: `src/main/render/SpriteVisualSpec.ts` (тип `SpriteVisualSpec`), `src/main/render/spriteScale.ts` (`export const PX_PER_WU = 70` — единственный источник scale, проверка grep-тестом). Без area-кода. | опоры: `design/sprite-assets.md` |
