...
- Правила выбора (определяют, что **должно** играть в данный момент):
  - `phase === menu` → играет fixed menu track `music/101-clock-ticking`.
