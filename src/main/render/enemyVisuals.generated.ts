...
export const DEMO_CARRIER_SLIME_VISUAL: SpriteVisualSpec = {
  archetypeId: 'demo-carrier-slime',
...
export const DEMO_RETALIATOR_SLIME_VISUAL: SpriteVisualSpec = {
  archetypeId: 'demo-retaliator-slime',
