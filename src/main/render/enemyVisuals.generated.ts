...
export const SLIME_ONE_EYE_VISUAL: SpriteVisualSpec = {
...
export const SLIME_HORNLING_VISUAL: SpriteVisualSpec = {
...
export const SLIME_MANY_EYE_VISUAL: SpriteVisualSpec = {
...
export const SLIME_STONEHEAD_VISUAL: SpriteVisualSpec = {
...
export const SLIME_SLEEPER_VISUAL: SpriteVisualSpec = {
...
export const SLIME_SPARK_VISUAL: SpriteVisualSpec = {
...
export const SLIME_WRAITH_VISUAL: SpriteVisualSpec = {
...
export const SLIME_SHELL_VISUAL: SpriteVisualSpec = {
...
export const SLIME_FLAME_VISUAL: SpriteVisualSpec = {
...
export const SLIME_MECH_CRAB_VISUAL: SpriteVisualSpec = {
...
export const SLIME_STACK_VISUAL: SpriteVisualSpec = {
...
export const SLIME_TRICKSTER_VISUAL: SpriteVisualSpec = {
...
export const SLIME_BUG_VISUAL: SpriteVisualSpec = {
...
export const SLIME_SAW_VISUAL: SpriteVisualSpec = {
...
export const SLIME_DRONE_VISUAL: SpriteVisualSpec = {
...
export const SLIME_STAR_VISUAL: SpriteVisualSpec = {
...
export const SLIME_ECHO_VISUAL: SpriteVisualSpec = {
...
export const SLIME_SPLITTER_VISUAL: SpriteVisualSpec = {
...
export const SLIME_PRINCE_VISUAL: SpriteVisualSpec = {
...
export const SLIME_KINGLING_VISUAL: SpriteVisualSpec = {
...
export const SLIME_FORTRESS_VISUAL: SpriteVisualSpec = {
...
export const SLIME_DASHER_VISUAL: SpriteVisualSpec = {
...
export const SLIME_TADPOLE_VISUAL: SpriteVisualSpec = {
...
export const SLIME_DOOR_VISUAL: SpriteVisualSpec = {
...
export const SLIME_MECH_VISUAL: SpriteVisualSpec = {
...
export const SLIME_CLAMPER_VISUAL: SpriteVisualSpec = {
...
export const SLIME_CANDLE_VISUAL: SpriteVisualSpec = {
...
export const SLIME_OBELISK_VISUAL: SpriteVisualSpec = {
...
export const SLIME_IDOL_VISUAL: SpriteVisualSpec = {
  archetypeId: 'slime-idol',
  image: '/assets/slime-45.png',
  sourceSizePx: { width: 165, height: 500 },
  worldSize: { width: 0.6875, height: 2.0833333333333335 },
  anchor: { x: 0.5, y: 0.5 }
...
export const SLIME_NINJA_VISUAL: SpriteVisualSpec = {
...
export const ENEMY_VISUAL_SPECS = [SLIME_ONE_EYE_VISUAL, SLIME_HORNLING_VISUAL, SLIME_MANY_EYE_VISUAL, SLIME_STONEHEAD_VISUAL, SLIME_SLEEPER_VISUAL, SLIME_SPARK_VISUAL, SLIME_WRAITH_VISUAL, SLIME_SHELL_VISUAL, SLIME_FLAME_VISUAL, SLIME_MECH_CRAB_VISUAL, SLIME_STACK_VISUAL, SLIME_TRICKSTER_VISUAL, SLIME_BUG_VISUAL, SLIME_LIFTER_VISUAL, SLIME_SAW_VISUAL, SLIME_DRONE_VISUAL, SLIME_STAR_VISUAL, SLIME_ECHO_VISUAL, SLIME_SPLITTER_VISUAL, SLIME_PRINCE_VISUAL, SLIME_KINGLING_VISUAL, SLIME_FORTRESS_VISUAL, SLIME_DASHER_VISUAL, SLIME_TADPOLE_VISUAL, SLIME_DOOR_VISUAL, SLIME_MECH_VISUAL, SLIME_CLAMPER_VISUAL, SLIME_CANDLE_VISUAL, SLIME_OBELISK_VISUAL, SLIME_IDOL_VISUAL, SLIME_NINJA_VISUAL] as const satisfies ReadonlyArray<SpriteVisualSpec>;
