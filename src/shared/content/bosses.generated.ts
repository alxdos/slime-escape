...
export const BOSS_GARGOYLE: BossArchetype = {
  ...
  radius: 1.15,
  contactBox: { width: 3.495, height: 2.85 },
  maxHp: 35,
  maxSpeed: 3.2,
  color: 0xaa44ff,
  contactDamage: 2,
...
export const BOSS_SAW_CYCLOPS: BossArchetype = {
  ...
  radius: 1.25,
  contactBox: { width: 2.265, height: 2.65 },
  maxHp: 45,
  maxSpeed: 2.4,
  color: 0xaa44ff,
  contactDamage: 3,
...
export const BOSS_SCRAP_KING: BossArchetype = {
  ...
  radius: 1.35,
  contactBox: { width: 3.41, height: 3.935 },
  maxHp: 40,
  maxSpeed: 3,
  color: 0xaa44ff,
  contactDamage: 2,
...
export const BOSS_TOWER_SENTINEL: BossArchetype = {
  ...
  radius: 1.3,
  contactBox: { width: 2.175, height: 3.54 },
  maxHp: 50,
  maxSpeed: 1.8,
  color: 0xaa44ff,
  contactDamage: 3,
...
export const BOSS_BUBBLE_HOG: BossArchetype = {
  ...
  radius: 1.2,
  contactBox: { width: 2.665, height: 2.87 },
  maxHp: 42,
  maxSpeed: 2.6,
  color: 0xaa44ff,
  contactDamage: 2,
